...
namespace CustomDlxLib
{
    public class ParallelizedDlx
    {
        ...
        public void Solve()
        {
            ...
            using var file = new StreamWriter("parallel init_time.csv", true);
        ...
        private void Init()
        {
            ...
            Parallel.For(0, 323, i =>
            {
                columnsNodes[i].Right = columnsNodes[i + 1];
                columnsNodes[i + 1].Left = columnsNodes[i];
            });
            
            root.Right = columnsNodes[0];
            columnsNodes[0].Left = root;
